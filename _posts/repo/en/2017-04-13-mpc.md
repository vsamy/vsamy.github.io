...
post_url: copra
title: Copra
permalink: en/git-repository/copra
---
...
As a shared pointer are needed, specifics functions have been developed for constraints, costs and the system.
...
## Examples
You find a c++ example [here]({{site.url}}/en/blog/mpc-example-cpp) and a Python example [here]({{site.url}}/en/blog/mpc-example-python)
